 ...
 * @param {{'Easy': Number, 'Medium': Number, 'Hard', Number}} difficultyPercentageDistribution 
 * @returns 
 */
...
const getquestions = (questionStore, totalMarks, difficultyPercentageDistribution) => {
    ...
    for (const [difficulty, percentage] of Object.entries(difficultyPercentageDistribution)) {
        const difficultyQuestions = shuffledQuestions.filter(q => q.difficulty === difficulty)
...
const myquestions = getquestions(questionStore, 180, difficultyPercentageDistribution);

console.log(myquestions);
console.log(myquestions[0].length);
console.log(myquestions[1].length);
console.log(myquestions[2].length);